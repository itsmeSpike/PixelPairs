...
public class hardlevel extends AppCompatActivity {
    ...
    private final ImageView[] cards = new ImageView[20];
    private final Integer[] cardImages = {
            ...
            R.drawable.pacman7, R.drawable.pacman8, R.drawable.pacman9, R.drawable.pacman10
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hardlevel);

        playingAsText = findViewById(R.id.hplayingastext);
        ...
        if (selectedTimer == null) selectedTimer = "2 Minutes"; // fallback
        ...
        if (firstFlippedCard == null) {
            ...
            if (Objects.equals(firstFlippedCard.getTag(), secondFlippedCard.getTag())) {
                ...
                if (correctMatches == 10) {
                    ...
                    editor.putString("difficulty_" + scoreCount, "Hard");
                    editor.putInt("score_count", scoreCount + 1);
                    editor.apply();

                    Intent intent = new Intent(hardlevel.this, victorypopup.class);
                    intent.putExtra("accuracy", accuracy);
                    intent.putExtra("selectedDifficulty", "Hard");
        ...
        countDownTimer = new CountDownTimer(timerDuration * 1000L, 1000) {
            ...
            public void onFinish() {
                ...
                if (!gameFinished && !isFinishing()) {
                    Toast.makeText(hardlevel.this, "Time's Up!", Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(hardlevel.this, timesuppopup.class);
                    intent.putExtra("accuracy", accuracy);
                    intent.putExtra("selectedDifficulty", "Hard");
                    intent.putExtra("selectedTimer", selectedTimer);
                    startActivity(intent);
