...
public class mediumlevel extends AppCompatActivity {
    ...
    private final ImageView[] cards = new ImageView[16];
    private final Integer[] cardImages = {
            R.drawable.pacman1, R.drawable.pacman2, R.drawable.pacman3,
            R.drawable.pacman4, R.drawable.pacman5, R.drawable.pacman6, R.drawable.pacman7, R.drawable.pacman8
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mediumlevel);

        playingAsText = findViewById(R.id.mplayingastext);  // make sure this ID matches the XML
        ...
        if (firstFlippedCard == null) {
            ...
            if (Objects.equals(firstFlippedCard.getTag(), secondFlippedCard.getTag())) {
                ...
                if (correctMatches == 8) {
                    ...
                    editor.putString("difficulty_" + scoreCount, "Medium");
                    editor.putInt("score_count", scoreCount + 1);
                    editor.apply();

                    Intent intent = new Intent(mediumlevel.this, victorypopup.class);
                    intent.putExtra("accuracy", accuracy);
                    intent.putExtra("selectedDifficulty", "Medium");
        ...
        countDownTimer = new CountDownTimer(timerDuration * 1000L, 1000) {
            ...
            public void onFinish() {
                ...
                if (!gameFinished && !isFinishing()) {
                    Toast.makeText(mediumlevel.this, "Time's Up!", Toast.LENGTH_SHORT).show();
                    ...
                    Intent intent = new Intent(mediumlevel.this, timesuppopup.class);
                    intent.putExtra("accuracy", accuracy);
                    intent.putExtra("selectedDifficulty", "Medium");
                    intent.putExtra("selectedTimer", selectedTimer);
                    startActivity(intent);
